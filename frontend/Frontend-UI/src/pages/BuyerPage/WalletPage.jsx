                                    ...
                                    {transactions.map((tx, index) => (
                                        <div key={tx.id || index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                                            <div className="flex items-center space-x-3">
                                                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${tx.type === 'DEPOSIT' ? 'bg-green-100' : 'bg-blue-100'
                                                    }`}>
                                                    {tx.type === 'DEPOSIT' ? (
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
                        ...
                        <form onSubmit={handleDeposit}>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="space-y-3">
                                    <label className={`flex items-center p-4 border-2 rounded-xl cursor-pointer transition ${depositMethod === 'bank_transfer'
                                    ...
                                    <label className={`flex items-center p-4 border-2 rounded-xl cursor-pointer transition ${depositMethod === 'credit_card'
                                        ? 'border-green-600 bg-green-50'
                                        : 'border-gray-200 hover:border-green-300'
                                        }`}>
                                        <input
