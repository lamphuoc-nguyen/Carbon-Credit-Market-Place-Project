                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                            ...
                            <div
                                ...
                                className={`p-4 rounded-xl border-2 cursor-pointer transition mb-4 ${paymentMethod === 'wallet'
                                        ? 'border-green-600 bg-green-50'
                                        : 'border-gray-200 hover:border-green-300'
                                    }`}
                            >
                                <div className="flex items-start">
                                    <div className={`w-6 h-6 rounded-full border-2 mt-1 mr-3 flex items-center justify-center ${paymentMethod === 'wallet' ? 'border-green-600' : 'border-gray-300'
                                        }`}>
                            ...
                            <div
                                ...
                                className={`p-4 rounded-xl border-2 cursor-pointer transition mb-4 ${paymentMethod === 'vnpay'
                                        ? 'border-orange-600 bg-orange-50'
                                        : 'border-gray-200 hover:border-orange-300'
                                    }`}
                            >
                                <div className="flex items-start">
                                    <div className={`w-6 h-6 rounded-full border-2 mt-1 mr-3 flex items-center justify-center ${paymentMethod === 'vnpay' ? 'border-orange-600' : 'border-gray-300'
                                        }`}>
                                        {paymentMethod === 'vnpay' && (
                            ...
                            <div
                                ...
                                className={`p-4 rounded-xl border-2 cursor-pointer transition ${paymentMethod === 'banking'
                                        ? 'border-blue-600 bg-blue-50'
                                        : 'border-gray-200 hover:border-blue-300'
                                    }`}
                            >
                                <div className="flex items-start">
                                    <div className={`w-6 h-6 rounded-full border-2 mt-1 mr-3 flex items-center justify-center ${paymentMethod === 'banking' ? 'border-blue-600' : 'border-gray-300'
                                        }`}>
