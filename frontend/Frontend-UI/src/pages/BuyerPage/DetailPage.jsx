                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                            <div className="bg-gradient-to-r from-green-600 to-emerald-600 p-8 text-white">
                                <div className="flex justify-between items-start mb-4">
                                    <span className={`px-4 py-2 rounded-full text-sm font-bold ${listing.listingType === 'FIXED'
                                            ? 'bg-white/20 backdrop-blur'
                                            : 'bg-orange-500'
                                        }`}>
                                        {listing.listingType === 'FIXED' ? '💵 Fixed Price' : '🎯 Auction'}
                                    </span>
                                    <span className={`px-4 py-2 rounded-full text-sm font-bold ${listing.status === 'ACTIVE'
                                            ? 'bg-green-500'
                                            : 'bg-gray-500'
                                        }`}>
                                        {listing.status}
