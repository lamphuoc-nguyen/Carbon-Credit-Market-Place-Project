                            ...
                            <div className="mb-4">
                                ...
                                <div className="space-y-2">
                                    <button
                                        ...
                                        className={`w-full px-4 py-2.5 rounded-lg font-medium cursor-pointer text-sm transition ${listingTypeFilter === 'ALL'
                                    ...
                                    <button
                                        ...
                                        className={`w-full px-4 py-2.5 rounded-lg font-medium cursor-pointer text-sm transition ${listingTypeFilter === 'FIXED'
                                    ...
                                    <button
                                        ...
                                        className={`w-full px-4 py-2.5 rounded-lg font-medium cursor-pointer text-sm transition ${listingTypeFilter === 'AUCTION'
                                            ...
                                            >
                                                ...
                                                <div className="bg-gradient-to-r from-green-50 to-blue-50 p-4 border-b border-gray-200">
                                                    <div className="flex justify-between items-start mb-3">
                                                        {/* Listing Type Badge */}
                                                        <span className={`px-3 py-1.5 rounded-full text-xs font-semibold ${listing.listingType === 'FIXED'
                                                        ...
                                                        {/* Status Badge */}
                                                        <span className={`px-3 py-1.5 rounded-full text-xs font-semibold ${listing.status === 'ACTIVE'
                                                        ...
                                                        <div className="flex items-start justify-between mb-4">
                                                            <div className="flex-1">
                                                                ...
                                                                <div className="flex gap-2 mb-4">
                                                                    <span className={`px-3 py-1 rounded-full text-xs font-semibold ${listing.listingType === 'FIXED'
                                                                            ? 'bg-green-500 text-white'
                                                                            : 'bg-orange-500 text-white'
                                                                        }`}>
                                                                        {listing.listingType === 'FIXED' ? '💵 Fixed Price' : '🎯 Auction'}
