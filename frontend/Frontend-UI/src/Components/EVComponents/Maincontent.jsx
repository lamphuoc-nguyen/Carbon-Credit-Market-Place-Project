            ...
            <div className="flex border border-gray-300 rounded-md overflow-hidden">
              <button
                ...
                className={`p-2.5 transition-colors ${
                  viewMode === 'grid' ? 'bg-yellow-400 text-gray-900' : 'bg-white hover:bg-gray-50'
                }`}
              >
                <Grid3x3 size={20} />
              </button>
              <button
                ...
                className={`p-2.5 border-l border-gray-300 transition-colors ${
                  viewMode === 'list' ? 'bg-yellow-400 text-gray-900' : 'bg-white hover:bg-gray-50'
                }`}
              >
                <List size={20} />
              </button>
              <button
                ...
                className={`p-2.5 border-l border-gray-300 transition-colors ${
                  viewMode === 'map' ? 'bg-yellow-400 text-gray-900' : 'bg-white hover:bg-gray-50'
                }`}
              >
                <Map size={20} />
              </button>
