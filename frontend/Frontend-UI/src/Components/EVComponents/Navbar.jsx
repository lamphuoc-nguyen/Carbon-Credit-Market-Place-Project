                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center gap-6">
                        <NavLink
                            to="/ev-dashboard"
                            className={({ isActive }) =>
                                `flex items-center gap-2 px-3 py-2 rounded-lg font-medium transition-all duration-300 ${isActive
                    ...
                    <div className="md:hidden border-t border-gray-200 py-4">
                        ...
                        <div className="space-y-1">
                            <NavLink
                                to="/ev-dashboard"
                                className={({ isActive }) =>
                                    `flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-all ${isActive ? 'text-green-600 bg-green-50' : 'text-gray-600 hover:bg-gray-50'
                                    }`
                                }
