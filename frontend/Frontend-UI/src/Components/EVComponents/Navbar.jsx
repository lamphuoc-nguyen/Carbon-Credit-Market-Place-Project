  ...
  return (
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          {/* Logo */}
          <Link to={isAuthenticated ? "/ev-dashboard" : "/home"} className="flex items-center gap-2 cursor-pointer group">
            ...
            <div className="hidden sm:block">
              ...
              <span className="text-gray-500 text-sm ml-2">{isAuthenticated ? 'EV Owner' : 'Marketplace'}</span>
            </div>
          </Link>
