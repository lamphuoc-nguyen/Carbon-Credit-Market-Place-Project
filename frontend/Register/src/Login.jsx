    ...
    return (
        <div>
            <div className='bg-white border border-black rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-lg bg-opacity-30 relative'>
                <h1 className='text-4xl font-bold text-center mb-6 text-black'>Register</h1>
                <form>
                    ...
                    <span className="text-center text-[14px] block text-black">
                        Already have an account? <button type="button" className="font-semibold text-blue-500 hover:text-blue-400 ">Login</button>
                    </span>
                </form>
            </div>
        </div>
